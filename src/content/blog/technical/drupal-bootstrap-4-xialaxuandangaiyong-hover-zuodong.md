...
description: "之前在 [[Drupal] Bootstrap 下拉選單](/node/123) 提過將 click 下拉選單改成 hover 下拉選單，但只適用於 Bootstrap 3。 以下是適用 Bootstrap 4.1.2 以上的作法 [1] javascript function toggleDropdown (e) { const d = $(e.targe"
...
之前在 [[Drupal] Bootstrap 下拉選單](/node/123) 提過將 click 下拉選單改成 hover 下拉選單，但只適用於 Bootstrap 3。
